...
const translations: Translations = {
  ...
  'painter.denied': { en: 'Denied', es: 'Denegado' },
  'painter.denialReason': { en: 'Reason', es: 'Motivo' },
  'painter.resubmit': { en: 'Resubmit', es: 'Reenviar' },
  ...
  'supervisor.timeLogs': { en: 'Time logs', es: 'Registros de tiempo' },
  'supervisor.filterProject': { en: 'Project', es: 'Proyecto' },
  'supervisor.filterPainter': { en: 'Painter', es: 'Pintor' },
  'supervisor.filterStatus': { en: 'Status', es: 'Estado' },
  'supervisor.noPendingCorrections': { en: 'No pending corrections', es: 'No hay correcciones pendientes' },
  'supervisor.shiftsForReview': { en: 'Shifts submitted for review', es: 'Turnos enviados a revisión' },
  'supervisor.correctionHistory': { en: 'Correction history', es: 'Historial de correcciones' },
  'supervisor.noCorrectionHistory': { en: 'No corrections yet', es: 'Aún no hay correcciones' },
